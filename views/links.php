<div class="page-links">
    <header class="page-header text-center mb-xl">
        <h1 class="text-fluid-xl mb-xs">Links</h1>
        <p class="text-xl text-muted">Interessante Seiten, Kooperationen und Empfehlungen aus der Region und darüber hinaus.</p>
    </header>
                        ...
                        <div class="link-item__icon">
                            <?php if ($faviconExists): ?>
                                <img src="<?= url($localFavicon) ?>" 
                                     alt="" 
                                     class="link-item__logo-img object-contain">
                            <?php else: ?>
